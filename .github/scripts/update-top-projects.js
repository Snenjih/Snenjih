...
async function updateReadme() {
  ...
  const mostActiveRepoRegex = /<a href="https:\/\/github\.com\/snenjih\/.*">\s*<img src="https:\/\/github-readme-stats\.vercel\.app\/api\/pin\/\?username=snenjih&repo=.*&theme=radical" alt="Most Active Repository" \/>\s*<\/a>/;
  const newMostActiveRepoContent = `<a href="${mostActiveRepo.html_url}">\n    <img src="https://github-readme-stats.vercel.app/api/pin/?username=snenjih&repo=${mostActiveRepo.name}&theme=radical" alt="Most Active Repository" />\n  </a>`;
